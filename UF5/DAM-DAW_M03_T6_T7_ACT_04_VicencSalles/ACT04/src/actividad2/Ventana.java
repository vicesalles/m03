...
public class Ventana extends JFrame {
	...
	public Ventana() {
		...
		//En hacer click al botón 'Aceptar'....
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(txtNombre.getText().length()==0){
					...
					JOptionPane.showMessageDialog(Ventana.this,"Debes seleccionar tu género","Error!",JOptionPane.ERROR_MESSAGE);
				}else if(chckbxDormir.isSelected()== false && chckbxComer.isSelected()== false && chckbxFornicar.isSelected()== false){
					JOptionPane.showMessageDialog(Ventana.this,"Debes seleccionar,al menos, una afición","Error!",JOptionPane.ERROR_MESSAGE);
				}else{
