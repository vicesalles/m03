...
public class Parseador {
	...
	try{
		...
		List<Element> llista = nodeArrel.getChildren("país");
		...
		for (int i=0; i<llista.size(); i++){
			...
			System.out.println("Población: "+ node.getChildText("población"));
			System.out.println("Superfície: "+ node.getChildText("superficie"));
			System.out.println("---------------------------------------------");
