...
public class ApartadoDos {
	...
	//Función que nos pide un String por medio de la frase que les pasemos.
	public static String pideString(String frase){
		//Checkeo que no hemos superado el número de fallos permitido
		checkFallos();
		String input="";
		...
		while (esInteger(input)){
			//le sumo un fallo por cada iteración
			fallos++;
			System.out.println("Aquí no puedes introducir números");
			return pideString(frase);			
		}
		//Le quito el fallo que 'injustamente' le he asignado en la iteración correcta.
		fallos--;		
		return input;
	
	}
	//Función que nos pide un int por medio de la frase que le pasemos.
	...
	//Check si se ha superado el número permitido de fallos
	public static void checkFallos(){
		...
		if(fallos>=5){
			...
			System.out.println("*******************************************************");
			System.out.println("ERROR NÚMERO DE FALLOS PERMITIDOS SUPERADO");
			System.out.println("*******************************************************");
			System.exit(0);
		}
